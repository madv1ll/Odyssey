...
INSERT INTO PRODUCTO_PROVEEDOR(NOMBRE, ID_PAIS_ID, RUT, DV) VALUES('SAMSUNG', 1, 12757228, '2');
INSERT INTO PRODUCTO_PROVEEDOR(NOMBRE, ID_PAIS_ID, RUT, DV) VALUES('HYPERX', 3, 12752998, '2');
INSERT INTO PRODUCTO_PROVEEDOR(NOMBRE, ID_PAIS_ID, RUT, DV) VALUES('ASUS', 1, 12452711, '2');
INSERT INTO PRODUCTO_PROVEEDOR(NOMBRE, ID_PAIS_ID, RUT, DV) VALUES('COUGAR', 1, 12729981, '1');
INSERT INTO PRODUCTO_PROVEEDOR(NOMBRE, ID_PAIS_ID, RUT, DV) VALUES('ZOTAC', 3, 15708875, '2');
...
INSERT INTO PRODUCTO_CATEGORIA(DESCRIPCION) VALUES('TARJETA DE VIDEO');

INSERT INTO PRODUCTO_PRODUCTO(NOMBRE, DESCRIPCION, IMAGEN, PRECIO, STOCK, ID_CATEGORIA_ID, ID_PROVEEDOR_ID) VALUES ('MONITOR SAMSUNG CURVO 24 PUL','MONITOR DE 24 PULGADAS DELGADO FULLHD  SAMSUNNG 1MS', 'productos/monitor1.jpg', 100000, 4, 4, 3);
INSERT INTO PRODUCTO_PRODUCTO(NOMBRE, DESCRIPCION, IMAGEN, PRECIO, STOCK, ID_CATEGORIA_ID, ID_PROVEEDOR_ID) VALUES ('TECLADO HYPERX ALLOY ORGIN','TECLADO GAMER MECÁNICO HYPERX ALLOY ORIGINS, ILUMINACIÓN RGB, USB TIPO', 'productos/teclado1.jpg', 25000, 3, 2, 4);
INSERT INTO PRODUCTO_PRODUCTO(NOMBRE, DESCRIPCION, IMAGEN, PRECIO, STOCK, ID_CATEGORIA_ID, ID_PROVEEDOR_ID) VALUES ('MOUSE HYPERX PULSE FIRE','MOUSE GAMER RGB HYPERX', 'productos/hyperx_pulsefire.jpg', 44000, 7, 1, 4);
INSERT INTO PRODUCTO_PRODUCTO(NOMBRE, DESCRIPCION, IMAGEN, PRECIO, STOCK, ID_CATEGORIA_ID, ID_PROVEEDOR_ID) VALUES ('AUDIFONOS HYPERX ALPHA','AUDIFONOS GAMER SONIDO 7.1 HYPERX', 'productos/hyperx_alpha.png', 75000, 9, 3, 4);
INSERT INTO PRODUCTO_PRODUCTO(NOMBRE, DESCRIPCION, IMAGEN, PRECIO, STOCK, ID_CATEGORIA_ID, ID_PROVEEDOR_ID) VALUES ('MONITOR ASUS TUF GAMMING','MONITOR 24 PULGADAS ASUS', 'productos/monitor_asus.jpg', 120000, 7, 4, 5);
INSERT INTO PRODUCTO_PRODUCTO(NOMBRE, DESCRIPCION, IMAGEN, PRECIO, STOCK, ID_CATEGORIA_ID, ID_PROVEEDOR_ID) VALUES ('AUDIFONS COUGAR PHONTUM F','AUDIFONOS COUGAR GAMER SONIDO 7.1', 'productos/audifonos_cougar.jpg', 59900, 5, 3, 6);
INSERT INTO PRODUCTO_PRODUCTO(NOMBRE, DESCRIPCION, IMAGEN, PRECIO, STOCK, ID_CATEGORIA_ID, ID_PROVEEDOR_ID) VALUES ('AUDIFONOS HYPERX CLOUD FLIGHT','AUDIFONOS GAMER SONIDO 7.1 HYPERX', 'productos/hyperx_cloud.jpg', 100000, 6, 3, 4);
INSERT INTO PRODUCTO_PRODUCTO(NOMBRE, DESCRIPCION, IMAGEN, PRECIO, STOCK, ID_CATEGORIA_ID, ID_PROVEEDOR_ID) VALUES ('MOUSE LOGITECH G903','MOUSE GAMER LOGITECH', 'productos/g903.jpg', 45000, 4, 1, 1);
INSERT INTO PRODUCTO_PRODUCTO(NOMBRE, DESCRIPCION, IMAGEN, PRECIO, STOCK, ID_CATEGORIA_ID, ID_PROVEEDOR_ID) VALUES ('GTX 1650 ZOTAC','TARJETA DE VIDEO DE MARCA ZOTAC', 'productos/zotac_gtx_1650.jpg', 229000, 8, 6, 7);
